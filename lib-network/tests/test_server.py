...
def _start_client(tcp_client):
    ...
    # response = tcp_client.send({"msg": "ping"})
    # # print(response)
    # response = tcp_client.send({"type": "im", "msg": "1"})
    ...
    # response = tcp_client.send({"type": "im", "msg": "1"})
    # response = tcp_client.send({"type": "im", "msg": "1"})
    # response = tcp_client.send({"type": "im", "msg": "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"})
    # response = tcp_client.send({"type": "im", "msg": "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"})
    # response = tcp_client.send({"type": "im", "msg": "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"})
    # response = tcp_client.send({"type": "im", "msg": "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"})
    # response = tcp_client.send({"type": "im", "msg": "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"})
    ...
    # response = tcp_client.send({"type": "get_messages"})
